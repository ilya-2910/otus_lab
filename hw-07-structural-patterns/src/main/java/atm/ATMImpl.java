...
public class ATMImpl implements ATM {
    ...
    List<Nominal> initNominals = new ArrayList<>();

    public ATMImpl(List<Nominal> initNominals) {
        init(initNominals);
    }

    public void init(List<Nominal> rawNominals) {
        initNominals = rawNominals;
    ...
    public void restore() {
        atmStorage.clear();
        atmStorage.addNominals(initNominals);
    }
