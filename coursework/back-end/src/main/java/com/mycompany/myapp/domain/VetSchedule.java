...
public class VetSchedule implements Serializable {
    ...
    public VetSchedule startDate(Instant startDate) {
    ...
    public VetSchedule endDate(Instant endDate) {
    ...
    public VetSchedule vet(Vet vet) {
        this.vet = vet;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VetSchedule)) {
            return false;
        }
        return id != null && id.equals(((VetSchedule) o).id);
    }
