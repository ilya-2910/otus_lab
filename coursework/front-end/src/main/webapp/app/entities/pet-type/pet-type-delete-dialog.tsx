...
export const PetTypeDeleteDialog = (props: IPetTypeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="courseworkApp.petType.delete.question">Are you sure you want to delete this PetType?</ModalBody>
      <ModalFooter>
        <Button color="secondary" onClick={handleClose}>
          <FontAwesomeIcon icon="ban" />
          &nbsp; Cancel
        </Button>
        <Button id="jhi-confirm-delete-petType" color="danger" onClick={confirmDelete}>
